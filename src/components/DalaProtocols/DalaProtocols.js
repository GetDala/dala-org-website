      ...
      <section id="DalaProtocols" name="pageDalaProtocols">
        ...
        <div className="hero protocols-hero">
          <div className="hero-body">
            <div className="container">
              <div className="columns is-desktop protocols">
                <div className="column is-one-third-desktop">
                  ...
                  <p className="no-margin"><strong>Launch Date: Q1 2019</strong></p>
                </div>
                <div className="column is-one-third-desktop">
                  ...
                  <p className="no-margin"><strong>Launch Date: Q4 2018</strong></p>
                </div>
                <div className="column is-one-third-desktop">
