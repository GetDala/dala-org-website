            ...
            <div className="column is-8 is-offset-2">
              <header className="section-header has-text-centered">
                ...
                <h3 className="section-description">
                  To enable a zero-fee and borderless financial system for emerging market consumers, a new crypto-token, Dala, was issued by the Dala Corporation.
                </h3>
              </header>
            </div>
          </div>
          ...
          <div className="section-content">
            <div className="columns is-desktop">
              <div className="column float-on-desktop">
                <p>
                  The Dala utility token is a general-purpose ERC-20 cryptographic token developed by the Dala Corporation and issued on the public Ethereum blockchain. The token is fractionally divisible and is independent of all local currencies and cryptocurrencies. Consumers will be able to engage in the Dala ecosystem by making transfers using their own token wallets, via the Wala Financial Platform (Dala's launch partner), or through other applications built using the Dala API.
                </p>
                <p>
                  The Dala Corporation is a private exempted company incorporated in the Cayman Islands and is intended to become a fully-decentralized autonomous organization (known as a DAO). However, due to the infancy of the crypto governance space, the Dala Corporation will assist with providing a governance forum, administer and maintain the Dala token economy in the short-term.
                </p>
              </div>
