    ...
    return (
      <section id="Team">
        ...
        <div className="team-members is-clearfix">
          <div className="team-member-wrapper" onClick={() => this.openPopupbox('tricia')}>
          ...
          <div className="team-member-wrapper" onClick={() => this.openPopupbox('samer')}>
          ...
          <div className="team-member-wrapper" onClick={() => this.openPopupbox('ross')}>
          ...
          <div className="team-member-wrapper" onClick={() => this.openPopupbox('llew')}>
